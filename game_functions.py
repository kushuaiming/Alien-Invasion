...
def update_bullets(ai_settings, screen, ship, aliens, bullets):
    """Upadate position of bullets and get rid of old bullets."""
    bullets.update()
...
def ship_hit(ai_settings, stats, screen, ship, aliens, bullets):
    ...
    if stats.ship_left > 0:
        ...
        # Empty the list of aliens and bulltes.
        aliens.empty()
        bullets.empty()
...
def update_aliens(ai_settings, stats, screen, ship, aliens, bullets):
    """Check if the fleet is at an edge,and then update the options of all aliens in the fleet."""
